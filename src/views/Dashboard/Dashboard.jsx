...
class Dashboard extends React.Component {
  ...
  getWeatherData() {
    const url = "https://api.mapbox.com/geocoding/v5/mapbox.places/hamburg+grandweg+154.json?access_token=pk.eyJ1Ijoic2VyZ2lvNzQ3IiwiYSI6ImNrMGF5MGY5dTBtaHkzY3BpdTRkbnk1dXYifQ.xUquJszDYbvOoCUN5D34TA&liit=1";
            ...
            <Card>
              <CardHeader color="danger" stats icon>
                ...
                <div className="weather">
                  <h3 className={classes.cardCategory}>Weather</h3>
                  <p style={{ color: "#555" }} >{this.state.weather.place_name}</p>
                  <p style={{ color: "#555", fontSize: "2em", fontWeight: "bold" }}>
                    {this.state.weather.coordinates.latitude, this.state.weather.coordinates.longitude}
                  </p>
                  <h3 className={classes.cardTitle}>{this.state.weather.teperature} C</h3>
                  <TextField
                    id="weather-address-index"
                    label="Street"
                    // helperText="Required *"
                    size = "small"
                    // variant="outlined"
